...
pub struct apr_bucket_type_t {
    ...
    pub setaside: Option<extern "C" fn(e: *mut apr_bucket, pool: *mut apr_pool_t) -> apr_status_t>,

    pub split: Option<extern "C" fn(e: *mut apr_bucket, point: apr_size_t) -> apr_status_t>,

    pub copy: Option<extern "C" fn(e: *mut apr_bucket, c: *mut *mut apr_bucket) -> apr_status_t>,
}
...
extern "C" {
    ...
    pub fn apr_table_do(
        f: *mut ap_table_do_callback_fb,
        r: *mut c_void,
        table: *const apr_table_t,
        ...
    ) -> c_int;
...
pub union cmd_func2 {
    ...
    pub no_args:
        Option<unsafe extern "C" fn(parms: *mut cmd_parms, mconfig: *mut c_void) -> *const c_char>,
...
pub struct ap_configfile_t {
    pub getch: Option<extern "C" fn(ch: *mut c_char, param: *mut c_void) -> apr_status_t>,

    pub getstr: Option<
        extern "C" fn(buf: *mut c_void, bufsiz: apr_size_t, param: *mut c_void) -> apr_status_t,
    >,
...
pub type ap_out_filter_func =
    extern "C" fn(f: *mut ap_filter_t, b: *mut apr_bucket_brigade) -> apr_status_t;
...
pub type merge_config_fn =
    extern "C" fn(p: *mut apr_pool_t, base_conf: *mut c_void, new_conf: *mut c_void) -> *mut c_void;
pub type create_server_config_fn =
    extern "C" fn(p: *mut apr_pool_t, s: *mut server_rec) -> *mut c_void;
...
pub type raw_args_fn = extern "C" fn(
    parms: *mut cmd_parms,
    mconfig: *mut c_void,
    args: *const c_char,
) -> *const c_char;
pub type take_argv_fn = extern "C" fn(
    parms: *mut cmd_parms,
    mconfig: *mut c_void,
    argc: c_int,
...
pub type take1_fn =
    extern "C" fn(parms: *mut cmd_parms, mconfig: *mut c_void, w: *const c_char) -> *const c_char;
pub type take2_fn = extern "C" fn(
    parms: *mut cmd_parms,
    mconfig: *mut c_void,
    w: *const c_char,
    w2: *const c_char,
) -> *const c_char;
pub type take3_fn = extern "C" fn(
    parms: *mut cmd_parms,
    mconfig: *mut c_void,
    w: *const c_char,
    w2: *const c_char,
...
pub type flag_fn =
    extern "C" fn(parms: *mut cmd_parms, mconfig: *mut c_void, on: c_int) -> *const c_char;

pub type hook_handler_fn = extern "C" fn(r: *mut request_rec) -> c_int;
pub type hook_pre_config_fn =
    extern "C" fn(conf: *mut apr_pool_t, log: *mut apr_pool_t, temp: *mut apr_pool_t) -> c_int;
pub type hook_check_config_fn = extern "C" fn(
    conf: *mut apr_pool_t,
    log: *mut apr_pool_t,
    temp: *mut apr_pool_t,
    s: *mut server_rec,
...
pub type hook_post_config_fn = extern "C" fn(
    conf: *mut apr_pool_t,
    log: *mut apr_pool_t,
    temp: *mut apr_pool_t,
    s: *mut server_rec,
...
pub type ap_table_do_callback_fb =
    extern "C" fn(r: *mut request_rec, key: *const c_char, value: *const c_char) -> c_int;
...
extern "C" {
    ...
    pub fn ap_register_provider(
        pool: *mut apr_pool_t,
        provider_group: *const c_char,
        provider_name: *const c_char,
        provider_version: *const c_char,
        provider: *const c_void,
    ) -> apr_status_t;
    pub fn ap_lookup_provider(
        provider_group: *const c_char,
        provider_name: *const c_char,
        provider_version: *const c_char,
    ) -> *mut c_void;
    ...
    pub fn ap_hook_handler(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_pre_config(
        f: Option<hook_pre_config_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    //   pub fn ap_hook_check_config(f: Option<hook_check_config_fn>, pre: *const *const c_char, succ: *const *const c_char, order: c_int);
    pub fn ap_hook_test_config(
        f: Option<hook_test_config_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_post_config(
        f: Option<hook_post_config_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_create_request(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_translate_name(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_map_to_storage(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_check_user_id(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_fixups(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_type_checker(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_access_checker(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_access_checker_ex(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_auth_checker(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_log_transaction(
        f: Option<hook_handler_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_child_init(
        f: Option<hook_child_init_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    ...
    pub fn ap_register_output_filter(
        name: *const c_char,
        filter_fn: Option<ap_out_filter_func>,
        init_fn: Option<ap_init_filter_func>,
        filter_type: ap_filter_type,
    ) -> *const ap_filter_rec_t;
    pub fn ap_hook_insert_filter(
        f: Option<hook_insert_output_filter_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
    );
    pub fn ap_hook_insert_error_filter(
        f: Option<hook_insert_output_filter_fn>,
        pre: *const *const c_char,
        succ: *const *const c_char,
        order: c_int,
